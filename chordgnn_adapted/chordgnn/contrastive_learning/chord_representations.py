...
def time_divided_tsv_to_note_array(time_divided_tsv_path):
    ...
    X = createfunction(filtered_df, time_signature)
    return X
...
def tie_consecutive_notes(note_array):
...
# @exit_after(45)
def time_divided_tsv_to_part(time_divided_tsv_path):
    ...
    note_array = time_divided_tsv_to_note_array(time_divided_tsv_path)
    note_array = tie_consecutive_notes(note_array)

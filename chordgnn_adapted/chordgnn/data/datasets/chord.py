...
class AugmentedNetChordDataset(BuiltinDataset): #store all the tsv files of the dataset in variables
    ...
    def __init__(self, raw_dir=None, force_reload=False,
        ...
        url = "https://github.com/napulen/AugmentedNet/releases/download/v1.0.0/dataset.zip" #change the url to much the lakh dataset
